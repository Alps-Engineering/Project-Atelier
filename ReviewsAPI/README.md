...
The data were received in four .csv files, each containing the rows extracted from one table. Combined, the files contained just over 31 million records. Here is a representative [sample](./SampleData) of each file for reference.
